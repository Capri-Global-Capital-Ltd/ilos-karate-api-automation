Feature: User fetch the IFSC code
  Background:
    * url BASE_URL1
  ...
  @Sanity1 @tc0010
  Scenario: fetching the IFSC code
    Given path '/misc/verify-account/'
    And request {"beneficiary_account_no":"173010200000374","beneficiary_ifsc":"UTIB0000004"}
    When method POST
    Then status 200
