Feature: User add repayment bank
  ...
  Scenario: adding repayment bank
    ...
    And request {"applicant_id":921466,"applicant_name":"VERNON PHILLIPS","bank_account":{"bank_name":"BANK OF BARODA","ifsc_code":"BARB0LDALUC","branch_name":"LDA COLONY,LUCKNOW","account_number":"999999255","account_holder_name":"Vernon Albert Phillips","account_type":"Savings","account_since":"","default_repayment":true,"uid":"9aa21987-14cf-466e-87fa-55c117a3a3e1"}}
    When method PATCH
    Then status 200
