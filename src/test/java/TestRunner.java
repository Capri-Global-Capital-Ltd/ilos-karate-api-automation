...
public class TestRunner {
    ...
    public void JUnitTestRunner() {
        Results results = Runner.path(
              ...
              "src/test/java/loanxpress/disbursement/disb_docs_esign_history.feature",
              "src/test/java/loanxpress/disbursement/disb_get_generate_docs.feature",
              ...
              "src/test/java/loanxpress/disbursement/disb_generate_upload_url2.feature",
              "src/test/java/loanxpress/disbursement/disb_document _handler2.feature",
              "src/test/java/loanxpress/disbursement/disb_sanction_conditions.feature",
              "src/test/java/loanxpress/disbursement/disb_checklist.feature",
              "src/test/java/loanxpress/disbursement/disb_maker_submit.feature"
